...
public static class TypeMapper
{
    ...
    public static string GetFromGodotConversion(string variantExpr, string godotType)
    {
        ...
        return godotType switch
        {
            ...
            "PackedInt32Array" => $"{variantExpr}.AsInt32Array()",
            "PackedInt64Array" => $"{variantExpr}.AsInt64Array()",
            "PackedFloat32Array" => $"{variantExpr}.AsFloat32Array()",
            "PackedFloat64Array" => $"{variantExpr}.AsFloat64Array()",
